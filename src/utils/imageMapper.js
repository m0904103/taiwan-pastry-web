export const getPastryImage = (text) => {
  ...
  if (t.includes('彌月') || t.includes('滿月') || t.includes('紅蛋') || t.includes('油飯') || t.includes('收涎') || t.includes('四月日') || t.includes('成年禮') || t.includes('十六歲')) return './images/theme_baby.png';
  if (t.includes('婚嫁') || t.includes('訂婚') || t.includes('文定') || t.includes('喜餅') || t.includes('大餅') || t.includes('盒仔餅') || t.includes('歸寧')) return './images/theme_wedding.png';
  if (t.includes('歷史') || t.includes('傳說') || t.includes('老店') || t.includes('起源') || t.includes('發明') || t.includes('伍子胥') || t.includes('黨長發') || t.includes('陳基振') || t.includes('明鄭') || t.includes('沈正國') || t.includes('琉球') || t.includes('楊貴妃') || t.includes('重陽')) return './images/theme_history.png';
  if (t.includes('製作') || t.includes('烤') || t.includes('蒸') || t.includes('煮') || t.includes('炸') || t.includes('麵糰') || t.includes('包酥') || t.includes('麵粉') || t.includes('豬油') || t.includes('酥皮') || t.includes('油皮') || t.includes('水仙粉') || t.includes('發麵') || t.includes('熟成') || t.includes('模具') || t.includes('胡椒餅') || t.includes('繼光餅') || t.includes('糍粑') || t.includes('艾草') || t.includes('黑糖糕') || t.includes('創意') || t.includes('紅龍蛋') || t.includes('米糕') || t.includes('九層') || t.includes('月餅') || t.includes('花蓮薯') || t.includes('芋蔥粿')) return './images/theme_baking.png';
